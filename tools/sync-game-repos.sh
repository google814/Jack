...
GAMES="reading-game:words math-game:numbers match-game:match letters-game:letters chess:chess apples-game:apples sight-words:sight-words big-numbers:big-numbers"
